...
This module defines Pydantic models for OpenAI-compatible API requests and
responses.
"""
...
class ChatCompletionRequest(BaseModel):
    ...
    messages: List[Message] = Field(
        ..., min_length=1, max_length=100, description="List of messages"
    )
    ...
    user: Optional[str] = Field(
        None, description="Unique identifier for the end-user"
    )
...
class Model(BaseModel):
    ...
    created: int = Field(..., description="Unix timestamp of creation")
    owned_by: str = Field(
        default="google", description="Organization that owns the model"
    )
